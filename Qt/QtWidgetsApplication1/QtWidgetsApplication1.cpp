...
QtWidgetsApplication1::QtWidgetsApplication1(QWidget *parent)
    ...
    , currentIlluminance(0.0)
    , controlBarWidth(60)
    , topBarHeight(80)
    , rng(QDateTime::currentMSecsSinceEpoch())
    , normalwidth(3, 0.1)
    , normallength(6, 0.1)
    , int_dist(20, 120)
{
...
double QtWidgetsApplication1::getEnvironmentConfig(TimeOfDay time, int weatherMode) const
{
    ...
    if (time == TimeOfDay::Day) {
        switch(weatherMode) {
        case NOTHING: return 100000.0;  // 白天晴天
        case RAIN:    return 20000.0;   // 白天雨天
        case SNOW:    return 60000.0;   // 白天雪天
        }
    } else {
        switch(weatherMode) {
        case NOTHING: return 10000.0;   // 夜晚晴天
        case RAIN:    return 6000.0;    // 夜晚雨天
        case SNOW:    return 2000.0;    // 夜晚雪天
        }
    }
    return 10000.0;
}
